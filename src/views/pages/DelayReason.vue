      ...
      <CCardBody>
        <template>
          <div class="wrapper">
            ...
            <!-- Add Modal Component -->
            <CModal title="Öteleme Sebebi Ekle" size="lg" :show.sync="largeModal">
              <CCardBody>
                <CInput label="Öteleme Sebebi:" horizontal placeholder="Giriniz..." v-model="addNew" />
              </CCardBody>
              <div slot="footer" class="w-100">
        ...
        <CModal title="Öteleme Sebebi Düzenle" size="lg" :show.sync="updateModal">
          <CCardBody>
            <CInput label="Öteleme Sebebi:" horizontal placeholder="Giriniz..." v-model="update.delayName" />
          </CCardBody>
          <div slot="footer" class="w-100">
...
export default {
  ...
  data() {
    return {
      ...
      addNew: "",
      largeModal: false,
      fields: [ { key: "id", label: "#", _style: "width:1cm;" },
        {
          key: "delayName",
