<template>
  <div>
    ...
    <CModal size="lg" :show.sync="warningModal" :closeOnBackdrop="false">
      <center>
        <h5>{{message}}</h5>
      </center>
      <div slot="footer" class="w-100">
  ...
  data() {
    return {
      fields: [
        ...
        { key: "companyTeam", label: "Firma-Takım", _style: "min-width=100px" },
        {
          key: "materialText",
        ...
        { key: "customer", label: "Müşteri", _style: "min-width=100px" },
        {
          key: "delayAmount",
  ...
  methods: {
    ...
    updateMethod(item) {
      axios
        ...
        .catch((e) => {
          this.updateButton = false;
          this.message = "Tekrar Deneyiniz! updateConraintFromModal";
          this.dangerModal = true;
        });
    },
    fetchReasons() {
